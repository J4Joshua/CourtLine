...
// RayBanApp.swift
//
// Main entry point for the RayBan sample app demonstrating the Meta Wearables DAT SDK.
...
struct RayBanApp: App {
  ...
  init() {
    do {
      ...
      #if DEBUG
      NSLog("[RayBan] Failed to configure Wearables SDK: \(error)")
      #endif
    }
